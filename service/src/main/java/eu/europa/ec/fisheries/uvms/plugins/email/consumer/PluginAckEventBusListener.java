...
public class PluginAckEventBusListener implements MessageListener {
    ...
    @EJB
    PluginService emailService;

    @Override
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void onMessage(Message inMessage) {

        LOG.info("Eventbus listener for email at selector: {} got a message", startupService.getPluginResponseSubscriptionName());
        ...
        try {
            ...
            LOG.error("[ Error when receiving message in email ]", e);
        }
    }
