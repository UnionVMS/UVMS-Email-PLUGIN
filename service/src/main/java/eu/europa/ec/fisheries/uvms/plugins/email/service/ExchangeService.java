...
import eu.europa.ec.fisheries.uvms.plugins.email.constants.ModuleQueue;
...
public class ExchangeService {
    ...
    public void sendMovementReportToExchange(SetReportMovementType reportType) {
        try {
            String text = ExchangeModuleRequestMapper.createSetMovementReportRequest(reportType, "EMAIL");
