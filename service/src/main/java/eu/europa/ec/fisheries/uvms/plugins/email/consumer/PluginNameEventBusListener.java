 ...
 */
package eu.europa.ec.fisheries.uvms.plugins.email.consumer;
...
import eu.europa.ec.fisheries.uvms.plugins.email.service.PluginService;
...
public class PluginNameEventBusListener implements MessageListener {
    ...
    public void onMessage(Message inMessage) {
        ...
        LOG.debug("Eventbus listener for email (MessageConstants.PLUGIN_SERVICE_CLASS_NAME): {}", startup.getRegisterClassName());
        ...
        try {
            ...
            LOG.error("[ Error when receiving message in email " + startup.getRegisterClassName() + " ]", e);
        } catch (JMSException ex) {
            LOG.error("[ Error when handling JMS message in email " + startup.getRegisterClassName() + " ]", ex);
        }
    }
}