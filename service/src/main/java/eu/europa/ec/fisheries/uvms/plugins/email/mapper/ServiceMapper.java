 ...
 */
package eu.europa.ec.fisheries.uvms.plugins.email.mapper;
...
public class ServiceMapper {
    ...
    public static ServiceType getServiceType(String serviceClassName, String emailDisplayName, String description, PluginType emailType, String responseMessageName) {
